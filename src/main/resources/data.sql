...
INSERT INTO debtor (id, name, surname, address, email, phone, observation, created_at, workspace_id) 
VALUES ('c3d4e5f6-a7b8-9c0d-1e2f-3a4b5c6d7e8f', 'Incorporadora', 'Alfa S.A.', 'Av. Paulista, 1000', 'financeiro@alfa.com', '11999998888', 'Cliente corporativo recorrente', CURRENT_TIMESTAMP, '11111111-1111-1111-1111-111111111111');
INSERT INTO debtor (id, name, surname, address, email, phone, observation, created_at, workspace_id) 
VALUES ('d4e5f6a7-b8c9-0d1e-2f3a-4b5c6d7e8f9a', 'Roberto', 'Alencar', 'Rua das Flores, 123', 'roberto.alencar@email.com', '11988887777', 'Caso cível em andamento', CURRENT_TIMESTAMP, '11111111-1111-1111-1111-111111111111');
INSERT INTO debtor (id, name, surname, address, email, phone, observation, created_at, workspace_id) 
VALUES ('e5f6a7b8-c9d0-1e2f-3a4b-5c6d7e8f9a0b', 'Juliana', 'Maximino', 'Rua Augusta, 456', 'ju.max@email.com', '11977776666', 'Irmã - empréstimo pessoal', CURRENT_TIMESTAMP, '11111111-1111-1111-1111-111111111111');

-- Debts (Professional Wallet)
INSERT INTO debt (id, wallet_id, debtor_id, user_id, name, email, description, amount, created_at, status, payment_type, workspace_id) 
...
INSERT INTO debt (id, wallet_id, debtor_id, user_id, name, email, description, amount, created_at, status, payment_type, workspace_id) 
VALUES ('f1a1b1c1-d1e1-4123-8123-a1b1c1d1e1f4', 'b2c3d4e5-f6a7-8b9c-0d1e-2f3a4b5c6d7e', 'e5f6a7b8-c9d0-1e2f-3a4b-5c6d7e8f9a0b', 'fd4437c0-bda6-489d-964f-7e43169cace0', 'Empréstimo Viagem', 'ju.max@email.com', 'Parcela 1/2 da viagem de final de ano', 600.00, CURRENT_TIMESTAMP, 'OPEN', 'PIX', '11111111-1111-1111-1111-111111111111');
